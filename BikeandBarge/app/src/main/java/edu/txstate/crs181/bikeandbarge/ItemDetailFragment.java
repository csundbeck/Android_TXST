package edu.txstate.crs181.bikeandbarge;
...
import edu.txstate.crs181.bikeandbarge.dummy.DummyContent;
...
public class ItemDetailFragment extends Fragment {
    ...
    {//The methods below define the actions that the app will take when an item is tapped in the master view
        ...
        } else if (mItem != null && mItem.id.equals("1")) {
